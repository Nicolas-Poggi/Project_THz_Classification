...
chmod +x mat_to_combined_image_all_parallel.sh
...
for i in {0..3}; do
    for j in {1..3}; do
        echo "Running: python 2_combined_image_creator_parallel.py $i $j"
        python 2_combined_image_creator_parallel.py $i $j
    done
done
