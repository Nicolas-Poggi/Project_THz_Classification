...
#SBATCH --output=slurm/one_shot_ICL/Calculate-THz_%A_%a.out 
#SBATCH --error=slurm/one_shot_ICL/Calculate-THz_%A_%a.err
...
then
    ...
    python nico_get_thz_result.py --model qwen --should_add_context True --test_description "$DESCRIPTION" --output_folder_filepath /pfs/work9/workspace/scratch/ma_npoggigo-bachelor_thesis_fss2025/Project_THz_Classification/experiments/1_first_experiment/1_one_shot_in_context_learning
else
    ...
    python nico_get_thz_result.py --model mistral --should_add_context True --test_description "$DESCRIPTION" --output_folder_filepath /pfs/work9/workspace/scratch/ma_npoggigo-bachelor_thesis_fss2025/Project_THz_Classification/experiments/1_first_experiment/1_one_shot_in_context_learning
fi
